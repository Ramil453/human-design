		...
		<>
			<div className='background-header-img'>
				<div className='container'>
					...
					<div className='header-title margin-bottom-56'>Centers</div>

					<main className='main centres-main'>
						<div className='information-box information-box-type'>
							<div className='information-text'>
								<div className='information-title'>Head Center</div>
								<div className='information-description'>
									Located at the top of the head...
								</div>
								<div className='additional-information-description information-description'>
									Located at the top of the head. It is associated with aspects
									of mental activity, analysis, abstract thinking and perception
									of new ideas..
								</div>
							</div>
						...
						<div className='information-box information-box-strategy'>
							<div className='information-text'>
								<div className='information-title'>Ajna Center</div>
								...
								<div className='additional-information-description3 information-description'>
									Located in the area between the eyebrows, above the bridge of
									the nose. Responsible for the ability to analyze information,
									intuition, evaluation and decision making.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
						...
						<div className='information-box information-box-inner'>
							<div className='information-text'>
								<div className='information-title'>Throat Center</div>
								...
								<div className='additional-information-description5 information-description'>
									Located in the throat area. Responsible for expression,
									communication and showing oneself in the world.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
						...
						<div className='information-box information-box-definition'>
							<div className='information-text'>
								<div className='information-title'>Heart Center</div>
								...
								<div className='additional-information-description6 information-description'>
									Located in the heart area. Associated with aspects of
									emotional expression, passions and inner motivation.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
						...
						<div className='information-box information-box-profile'>
							<div className='information-text'>
								<div className='information-title'>Solar Plexus Center</div>
								...
								<div className='additional-information-description7 information-description'>
									Located in the abdominal region. Responsible for emotional
									reactions, emotional support and intuitive decision making.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
						...
						<div className='information-box information-box-incarnation'>
							<div className='information-text'>
								<div className='information-title'>Sacral Center</div>
								...
								<div className='additional-information-description8 information-description'>
									Located in the lumbar region. It is associated with aspects of
									vital energy, efficiency and attraction.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
						...
						<div className='information-box information-box-signature'>
							<div className='information-text'>
								<div className='information-title'>Spleen Center</div>
								...
								<div className='additional-information-description9 information-description'>
									Located in the abdominal region. Responsible for intuitive
									perception of danger and concern for health.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
						...
						<div className='information-box information-box-digestion'>
							<div className='information-text'>
								<div className='information-title'>Splenic Center</div>
								<div className='information-description information-description10'>
									Also located in the abdomen...
								</div>
								<div className='additional-information-description10 information-description'>
									Also located in the abdomen. Associated with aspects of
									intuitive intelligence, self-defense, and assessment of
									situations.
								</div>
							</div>
							<div className='generate-wrapper'>
						...
						<div className='information-box information-box-design'>
							<div className='information-text'>
								<div className='information-title'>Root Center</div>
								<div className='information-description information-description11'>
									Located in the tailbone area...
								</div>
								<div className='additional-information-description11 information-description'>
									Located in the tailbone area. Responsible for aspects of
									stress, pressure, timing and dynamism.
								</div>
							</div>
							<div className='generate-wrapper'>
								<img
