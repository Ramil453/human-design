...
const Place = () => {
	...
	const styles = {
		control: (provided, state) => ({
			...provided,
			backgroundColor: '#2C516C0D', // Измените цвет фона

			width: '100%',
			padding: '10px',
			color: '#2C516C99',
			borderRadius: '10px',
			border: state.isFocused ? '2px solid #2C516C4D' : '1px solid #ccc',
			boxShadow: 'none',
			'&:hover': {
				border: '1px solid #2C516C4D',
			},
		}),
	}
	...
	const handleLinkClick = e => {
		if (!data) {
			...
			navigate('#')
			// localStorage('place', setData(e))
			localStorage.setItem('place', data.label)
		}
	}
		...
		<>
			<div className='container'>
				...
				<main className='main'>
					...
					<div className='text'>
						<h1 className='title'>
							State your place of <br /> birth
						</h1>
						<p className='description margin-bottom-75'>
							We will analyze the position of the <br /> stars and planets in
							your birthplace <br /> at the time you were born.
						</p>
					</div>
					<div className='input-wrapper place-input-wrapper margin-bottom-215'>
						<label htmlFor='place' className='input-title'>
							Place of birth
						</label>
					...
					<div className='indicator-wrapper'>
						...
						<div className='indicator'>
							<div className='indicator-percent'>100%</div>
							<div className='indicator-line'>
								<span className='parent-span'></span>
								<span className='children-span percent-100'></span>
							</div>
						</div>
					</div>
				</main>
