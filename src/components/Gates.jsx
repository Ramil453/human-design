...
const Gates = () => {
  	...
  	function openArrow1() {
		...
		document.querySelector('.additional-information-description').style.display = 'block'
	...
	function closeArrow1() {
		...
		document.querySelector('.additional-information-description').style.display = 'none'
	}
	...
	function openArrow2() {
		...
		document.querySelector('.additional-information-description2').style.display = 'block'
	...
	function closeArrow2() {
		...
		document.querySelector('.additional-information-description2').style.display = 'none'
	}
	...
	function openArrow3() {
		...
		document.querySelector('.additional-information-description3').style.display = 'block'
	...
	function closeArrow3() {
		...
		document.querySelector('.additional-information-description3').style.display = 'none'
	}
	...
	function openArrow4() {
		...
		document.querySelector('.additional-information-description4').style.display = 'block'
	...
	function closeArrow4() {
		...
		document.querySelector('.additional-information-description4').style.display = 'none'
	}
			...
			<div className='background-header-img'>
				<div className='container'>
					<header className='header margin-bottom-20'>
						...
						<div className='header-title'>Gates</div>
						<Link to='/settings'>
					...
					<main className='main'>
						<div className='list'>
							<ul>
								...
								<Link to='/sense'>
									<li className='color-blue'>Sense</li>
								</Link>
								<Link to='/strategy'>
									<li className='color-blue'>Strategy</li>
								</Link>
								<Link to='/gates'>
									<li className='highlight-btn'>Gates</li>
								</Link>
							</ul>
						</div>
