...
const Profile = () => {
	...
	const url = `https://api.bodygraphchart.com/v221006/hd-data?api_key=${API_KEY}&date=${userBirth} ${userTime}&timezone=Europe/Moscow`
	...
	useEffect(() => {
		...
		return () => {
			abortController.abort("Abort controller called")
		}
							...
							<div className='generate-wrapper'>
								<div className='user-info'>
									<div className='info-text'>
										<span className='info-title'>Birth date:</span> {userBirth}{' '}
										{}
									</div>
									<div className='info-text'>
										<span className='info-title'>Age:</span>
										{new Date().getFullYear() -
											new Date(userBirth).getFullYear()}
									</div>
									<div className='info-text'>
